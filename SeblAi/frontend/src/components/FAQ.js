...
const FAQ = () => {
    const faqData = [
        ...
        },
        {
          ...
          answer: (
            <>
              Sebil AI is a revolutionary tool that leverages artificial intelligence
              to provide personalized crop recommendations. By analyzing factors like
              humidity, pH, temperature, and rainfall, the system assists farmers in
              making informed decisions about which crops to cultivate. This leads to
              improved yields, efficient resource utilization, and sustainable
              practices.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              ...
              crop growth conditions. When a user inputs specific parameters, Sebil AI
              matches them against the learned patterns to provide accurate crop
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              agriculture, humidity levels influence plant growth, transpiration, and
              disease susceptibility. Sebil AI considers humidity data to recommend
              crops that thrive in varying humidity conditions.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              pH measures the acidity or alkalinity of the soil. Different crops have
              specific pH preferences. Sebil AI utilizes pH information to suggest
              crops that are well-suited to the soil’s pH level, promoting optimal
              growth.
            </>
          ),
        },
        ...
        },
        {
          ...
          answer: (
            <>
              Rainfall quantifies the amount of precipitation received in an area. It
              directly impacts water availability for crops. Sebil AI factors in
        ...
        answer: (
          <>
            Sebil AI strives for high accuracy by utilizing advanced machine learning
            techniques. The recommendations are based on extensive data analysis,
            resulting in reliable guidance for crop selection.
          </>
        ),
      },
      {
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            smartphones and tablets, allowing for convenient access while you're in
            the field.
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            Your feedback is valuable! Sebil AI encourages users to provide feedback
            through the platform. Your insights help refine the system's accuracy
            and improve future recommendations, making the tool even more
            beneficial.
          </>
        ),
      },
  ...
  return (
    <div className="w-full min-h-[calc(100vh-150px)] overflow-y-auto">
      <div className="w-[80%] lg:w-[50%] md:w-[80%] mx-auto mt-8 p-4 overflow-y-hidden">
        <h1 className="text-3xl font-semibold mb-4 text-[#396E8D]">Frequently Asked Questions</h1>
    ...
    <div class="text-start mt-5 sm:text-sm lg:text-base md:text-base">
      ...
      <ul class=" text-lg list-disc list-inside">
        <li class="mb-1">Make sure that all words are spelled correctly.</li>
